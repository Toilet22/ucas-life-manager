...
public class MoodHistoryActivity extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dailyView.setBackgroundResource(R.drawable.btn_day);
		...
		weeklyView.setBackgroundResource(R.drawable.btn_week);
		...
		monthlyView.setBackgroundResource(R.drawable.btn_month);
